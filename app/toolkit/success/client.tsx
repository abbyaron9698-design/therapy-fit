...
// app/toolkit/success/client.tsx
...
export default function ToolkitSuccessClient() {
  const sp = useSearchParams();

  const method = safeStr(sp.get("method")) || "skip"; // "email" | "skip" | "download"
      ...
      <div className="mx-auto max-w-3xl px-6 py-14">
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
          ...
          <div className="mt-8 rounded-3xl border border-slate-200 bg-white p-6">
            ...
            <p className="mt-2 text-sm text-slate-700">
              Pick 3 questions from the toolkit and bring them to your next consult. That’s enough to
              make progress.
            </p>
