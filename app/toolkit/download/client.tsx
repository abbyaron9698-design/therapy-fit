...
// app/toolkit/download/client.tsx
...
export default function ToolkitDownloadClient() {
  ...
  const downloadHref = useMemo(() => "/toolkit/TherapyFit-Decision-Toolkit.pdf", []);
  ...
  function buildSuccessHref(method: "email" | "skip" | "download") {
    ...
    return `/toolkit/success?${q.toString()}`;
  }

  function goSuccess(method: "email" | "skip" | "download") {
    window.location.href = buildSuccessHref(method);
  }

  function downloadThenSuccess() {
    ...
    a.href = downloadHref;
    a.download = "TherapyFit-Decision-Toolkit.pdf";
    document.body.appendChild(a);
    a.click();
    document.body.removeChild(a);

    window.setTimeout(() => goSuccess("download"), 250);
  }
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
          ...
          <div className="mt-8 rounded-3xl border border-slate-200 bg-slate-50 p-6">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <div className="text-sm font-semibold text-slate-900">Decision Toolkit (PDF)</div>
